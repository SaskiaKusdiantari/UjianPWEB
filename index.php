...
//membuat message saat melakukan delete dan edit
if (isset($_GET['op'])) {
    $op = $_GET['op'];
} else {
    $op = "";
...
//untuk melakukan create data baru
...
//untuk melakukan update data
    if ($npm && $nama && $alamat && $fakultas) {
        if ($op == 'edit') {
            $sql1       = "update data_mahasiswa set npm = '$npm',nama='$nama',alamat = '$alamat',fakultas='$fakultas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
//untuk melakukan insert ke dalam database
        } else {
            $sql1   = "insert into data_mahasiswa(npm,nama,alamat,fakultas) values ('$npm','$nama','$alamat','$fakultas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
